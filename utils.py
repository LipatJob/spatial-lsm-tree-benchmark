...
import os
class Logger:
    def __init__(self, log_suffx, console_log=False):
        self.log_file_path = f"./logs/benchmark/benchmark_{log_suffx}_{str(time.time())}.log"
        self.latest_log_file_path = f"./logs/benchmark/benchmark_{log_suffx}_latest.log"
